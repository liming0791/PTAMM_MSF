...
namespace PTAMM {
    ...
    void Tracker::TrackFrame(Image<CVD::byte> &imFrame, float* q, bool bDraw)
    {
        ...
        //__android_log_print(ANDROID_LOG_INFO, "Tracker::TrackFrame", "MakeKeyFrame ...");
        mCurrentKF.mMeasurements.clear();
        mCurrentKF.MakeKeyFrame_Lite(imFrame);
        //__android_log_print(ANDROID_LOG_INFO, "Tracker::TrackFrame",
        //        "MakeKeyFrame done, size : %d %d, first pointer data : %d",
        //        mCurrentKF.aLevels[0].im.size().x, mCurrentKF.aLevels[0].im.size().y,
        //        (int)((unsigned char *)mCurrentKF.aLevels[0].im.begin())[0]);
        ...
        if(mbDraw)
        {
            ...
            //__android_log_print(ANDROID_LOG_INFO, "Tracker::TrackFrame", "DrawPixels ...");
            //CVD::glDrawPixels(mCurrentKF.aLevels[0].im);
            //__android_log_print(ANDROID_LOG_INFO, "Tracker::TrackFrame", "DrawPixels done");

            //__android_log_print(ANDROID_LOG_INFO, "Tracker::TrackFrame", "Draw FAST Points ...");
        ...
        //__android_log_print(ANDROID_LOG_INFO, "Tracker::TrackFrame", "Track ...");
        ...
        if(mpMap->IsGood())
        {
            ...
            TrackForInitialMap();
        //__android_log_print(ANDROID_LOG_INFO, "Tracker::TrackFrame", "Track done");

        //__android_log_print(ANDROID_LOG_INFO, "Tracker::TrackFrame", "GUI interface ...");
        // GUI interface
        ...
        //__android_log_print(ANDROID_LOG_INFO, "Tracker::TrackFrame", "GUI interface done");
