...
GLWindow2::GLWindow2(ImageRef irSize, string sTitle)
{
    ...
    __android_log_print(ANDROID_LOG_INFO, "GLWindow2::GLWindow2", "mirWindowSize : %d %d, mirVideoSize : %d %d",
            mirWindowSize.x, mirWindowSize.y, mirVideoSize.x, mirVideoSize.y);
...
{
  //__android_log_print(ANDROID_LOG_INFO, "GLWindow2::SetupViewport", "Set ViewPort ...");
  glViewport(0, 0, size()[0], size()[1]);
  //__android_log_print(ANDROID_LOG_INFO, "GLWindow2::SetupViewport", "Set ViewPort done, size : %d %d",
  //      size()[0], size()[1]);
}

void GLWindow2::SetupVideoOrtho()
{
  //__android_log_print(ANDROID_LOG_INFO, "GLWindow2::SetupVideoOrtho", "Set VideoOrtho ...");
  glMatrixMode(GL_PROJECTION);
  glLoadIdentity();
  glOrtho(-0.5,(double)mirVideoSize.x - 0.5, (double) mirVideoSize.y - 0.5, -0.5, -1.0, 1.0);
  //__android_log_print(ANDROID_LOG_INFO, "GLWindow2::SetupVideoOrtho", "Set VideoOrtho done, mirVideoSize : %d %d",
  //      mirVideoSize.x, mirVideoSize.y);
}
