...
#define CKECK_ABORTS CHECK_RESET CHECK_REINIT CHECK_SWITCH CHECK_UNLOCK
            ...
            SE3<> &se3TrackerPose)
    {
        ...
        int levels[4] = {0, 3, 1, 2}; 
        AddSomeMapPoints(levels);
    ...
    void MapMaker::AddKeyFrameFromTopOfQueue()
    {
        ...
        int levels[4] = {3, 0, 1, 2};
        
        AddSomeMapPoints(levels);       // .. and add more map points by epipolar search.
