    ...
    requestFinish(false), finished(false)
{
  ...
  __android_log_print(ANDROID_LOG_INFO, "System::System", "new MapMaker ...");
  mpMapMaker = new MapMaker( mvpMaps, mpMap );

  __android_log_print(ANDROID_LOG_INFO, "System::System", "new Tracker ...");
  mpTracker = new Tracker(mVideoSource.Size(), *mpCamera, mvpMaps, mpMap, *mpMapMaker);

  __android_log_print(ANDROID_LOG_INFO, "System::System", "new ARDriver ...");
  mpARDriver = new ARDriver(*mpCamera, mVideoSource.Size(), mGLWindow, *mpMap);

  __android_log_print(ANDROID_LOG_INFO, "System::System", "new MapViewer ...");
  mpMapViewer = new MapViewer(mvpMaps, mpMap, mGLWindow);

  __android_log_print(ANDROID_LOG_INFO, "System::System", "new MapSerializer ...");
...
{
  {
      ...
      */ 
      ...
      if (!requestFinish)
      {
          ...
          //__android_log_print(ANDROID_LOG_INFO, "System::Run", "GetAndFillFrameBWandRGB ...");
          mVideoSource.GetAndFillFrameBWandRGB(mimFrameBW, mimFrameRGB);
          //__android_log_print(ANDROID_LOG_INFO, "System::Run", "GetAndFillFrameBWandRGB done, BW data : %d, RGBdata : %d",
          //        (int)(((unsigned char*)(mimFrameBW.data()))[0]), (int)(((unsigned char*)(mimFrameRGB.data()))[0]));
          static bool bFirstFrame = true;
          if(bFirstFrame)
          {

            //__android_log_print(ANDROID_LOG_INFO, "System::Run", "ARDriver init ...");
            mpARDriver->Init();
            //__android_log_print(ANDROID_LOG_INFO, "System::Run", "ARDriver init done");

            bFirstFrame = false;
          }
      }

      //__android_log_print(ANDROID_LOG_INFO, "System::Run", "GLWindow setup ...");
      mGLWindow.SetupViewport();
      mGLWindow.SetupVideoOrtho();
      mGLWindow.SetupVideoRasterPosAndZoom();
      //__android_log_print(ANDROID_LOG_INFO, "System::Run", "GLWindow setup done");
      ...
      if (!requestFinish)
      {
          //__android_log_print(ANDROID_LOG_INFO, "System::Run", "Draw ...");
          ...
          //__android_log_print(ANDROID_LOG_INFO, "System::Run", "Draw Map or AR done");

          //__android_log_print(ANDROID_LOG_INFO, "System::Run", "Draw Info and menue ...");
          if(*mgvnDrawMapInfo) {
            DrawMapInfo();
          }
          ...
          //__android_log_print(ANDROID_LOG_INFO, "System::Run", "sCaption : %s", sCaption.c_str());

          mGLWindow.DrawCaption(sCaption);
          mGLWindow.DrawMenus();
          //__android_log_print(ANDROID_LOG_INFO, "System::Run", "Draw Info and menue done");

          // test draw
          //__android_log_print(ANDROID_LOG_INFO, "System::Run", "test draw triangle ...");
          ...
          //glVertex3f(1.f, 1.f, 0);
          //glEnd();
          //__android_log_print(ANDROID_LOG_INFO, "System::Run", "test draw triangle done");

          //__android_log_print(ANDROID_LOG_INFO, "System::Run", "Draw done");
      }
      else
      {
      ...
      //__android_log_print(ANDROID_LOG_INFO, "System::Run", "mGLWindow.HandlePendingEvents ...");
      mGLWindow.HandlePendingEvents();
      //__android_log_print(ANDROID_LOG_INFO, "System::Run", "mGLWindow.HandlePendingEvents done");
