...
namespace msf_updates {
    namespace pose_measurement {
         ...
         */
        typedef msf_core::MSF_Measurement<PoseWithCovarianceStamped,
                    ...
                    struct PoseMeasurement : public PoseMeasurementBase {
                        private:
                            ...
                            virtual void MakeFromSensorReadingImpl(measptr_t msg) {
                                ...
                                // Get measurements.
                                z_p_ = Eigen::Matrix<double, 3, 1>(msg->position[0],
                                        msg->position[1],
                                        msg->position[2]);
                                z_q_ = Eigen::Quaternion<double>(msg->orientation[0],
                                        msg->orientation[1],
                                        msg->orientation[2],
                                        msg->orientation[3]);

                                printf("Pose_measurement: == %f %f %f == %f %f %f %f \n",
                                        z_p_[0], z_p_[1], z_p_[2], 
                                        z_q_.w(), z_q_.x(), z_q_.y(), z_q_.z());
